...
<div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-md shadow-md bg-gray-800">
    ...
    <form className="mt-6">
        ...
        <div className="mt-4">
            ...
            <input type="password" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md bg-gray-800 text-gray-300 border-gray-600 focus:border-blue-400 focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
        </div>
