...
<div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
    ...
    <p className="mt-8 text-xs font-light text-center text-gray-500"> Already have an account? <Link to='/login' className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Login</Link></p>
</div>
