...

            {
                    ...
                    <>
                        ...
                        <div className='container flex flex-col w-full max-w-lg p-6 mx-auto'>
                            <h3>Please  <Navigate to='/login' state={{from:location}} replace className="font-medium text-teal-300 dark:text-gray-200 hover:underline">Login</Navigate> to add a review</h3>
                        </div>
