	...
	<div className="container mx-auto space-y-12">
		<div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
			...
			<div className="flex flex-col justify-center flex-1 p-6 dark:bg-gray-900">
				...
				<p className="my-6 dark:text-gray-400">The best part about cake is that there can be a large variety of flavors and one can experiment with it quite often. Any flourishing cake shop would vouch by this criteria because variety keeps people interested.</p>
